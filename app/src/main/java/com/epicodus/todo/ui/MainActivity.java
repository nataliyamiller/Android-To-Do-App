...
import com.epicodus.todo.R;
import com.epicodus.todo.models.Category;
import com.epicodus.todo.models.Task;
...
public class MainActivity extends ListActivity {
    ...
    private EditText mNewCategoryTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewCategoryTest = (EditText) findViewById(R.id.newTask);
    ...
    private void addCategory() {
        String name = mNewCategoryTest.getText().toString();
...
//new Select().from(Task.class).where("Description= ?", description).executeSingle();